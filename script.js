...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.concept-card, .flow-item, .timeline-item, .point-item');
...
const revealElements = document.querySelectorAll('.section-header, .intro-content, .conclusion-text');
...
console.log(`
%c🌟 Chào mừng đến với Website Triết Học Biện Chứng! 🌟
%c
%cĐây là một website được xây dựng để khám phá mối quan hệ biện chứng 
giữa Cơ sở hạ tầng (CSHT) và Kiến trúc thượng tầng (KTTT) trong 
chủ nghĩa Mác-Lênin.

%cWebsite được thiết kế với:
• Giao diện hiện đại và responsive
• Nội dung triết học sâu sắc
• Trải nghiệm người dùng tối ưu
• Tương thích với mọi thiết bị

%cCảm ơn bạn đã ghé thăm! 🎓
`, 
